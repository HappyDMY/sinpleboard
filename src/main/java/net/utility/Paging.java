...
public class Paging {  
   ...
   * @return
   */
  public String paging(int totalRecord, int nowPage, int recordPerPage, String col, String word, String url){
    ...
    if (nowGrp >= 2){
      str.append("[<A href='"+url+"?col="+col+"&word="+word+"&nowPage="+_nowPage+"'>이전</A>]");
    }
    ...
    for(int i=startPage; i<=endPage; i++){
      ...
      if (nowPage == i){ // 현재 페이지이면 강조 효과
        ...
        str.append("<A href='"+url+"?col="+col+"&word="+word+"&nowPage="+i+"'>"+i+"</A>&nbsp;");
      }      
    }
    
    _nowPage = (nowGrp * pagePerBlock)+1; // 10개 다음 페이지로 이동
    if (nowGrp < totalGrp){
      str.append("[<A href='"+url+"?col="+col+"&word="+word+"&nowPage="+_nowPage+"'>다음</A>]");
    }
    str.append("</DIV>");
